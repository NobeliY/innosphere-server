const { NewsImagesController } = require('../models/models')
...
class NewsImagesController {
    async create(req, res, next) {
        try {
            ...
            if (req.files && 'img' in req.files) {
                ...
                const image = await NewsImagesController.create({ name: fileName, text })
    ...
    async getAll(req, res, next) {
        try {
            const images = await NewsImagesController.findAll()
...
module.exports = new NewsImagesController()